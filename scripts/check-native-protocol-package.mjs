...
try {
  ...
  const runtimeCheck = `
    ...
    import { captureAndValidateNativeProtocolDataMessage, negotiateNativeProtocol } from "dual-surface-ui/native-protocol";
  ...
  await writeFile(
    ...
    `import { captureAndValidateNativeProtocolDataMessage, negotiateNativeProtocol, type NativeProtocolClientHello } from "dual-surface-ui/native-protocol";\n` +
      ...
      `void captureAndValidateNativeProtocolDataMessage; void negotiateNativeProtocol; void hello;\n`,
  );
  await writeFile(
